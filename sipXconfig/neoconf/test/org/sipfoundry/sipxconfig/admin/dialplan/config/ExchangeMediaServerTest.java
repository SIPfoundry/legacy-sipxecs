...
public class ExchangeMediaServerTest extends TestCase {
    ...
    public void testGetHeaderParams() {
        assertEquals("Wrong header param string.", "Diversion=%3Csip:{digits}%40{host}"
                + "%3E%3Breason%3Dno-answer%3Bscreen%3Dno%3Bprivacy%3Doff", m_out
                .getHeaderParameterStringForOperation(Operation.VoicemailDeposit,
    ...
    public void testGetUriParams() {
        ...
        assertEquals("Wrong uri param string.", "transport=tcp", paramsForRetrieve);
    }

    public void testGetDigitsForOperation() {
        assertEquals("Wrong digits for voicemail deposit.", VOICEMAIL_EXTENSION, m_out
                .getDigitStringForOperation(Operation.VoicemailDeposit, CallDigits.FIXED_DIGITS));
    }
