...
public class SwitchConfigurationTest extends SipxServiceTestBase {
    ...
    public void testWrite() throws Exception {
        ...
        configuration.setTemplate("freeswitch/switch.conf.xml.vm");

        assertCorrectFileGeneration(configuration, "switch.conf.test.xml");
