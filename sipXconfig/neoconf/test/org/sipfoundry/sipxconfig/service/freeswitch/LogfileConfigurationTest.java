...
public class LogfileConfigurationTest extends SipxServiceTestBase {
    ...
    public void testWrite() throws Exception {
        ...
        configuration.setTemplate("freeswitch/logfile.conf.xml.vm");

        assertCorrectFileGeneration(configuration, "logfile.conf.test.xml");
