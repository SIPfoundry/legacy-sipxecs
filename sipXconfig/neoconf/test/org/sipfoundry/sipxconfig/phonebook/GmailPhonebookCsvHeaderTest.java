...
public class GmailPhonebookCsvHeaderTest extends TestCase {
    ...
    String[] gmailHeaderStrings = {
        ...
        "E-mail 1 - Type", "E-mail 1 - Value", "IM 1 - Type", "IM 1 - Service", "IM 1 - Value", "Phone 1 - Type",
    ...
    String[] gmailRow = {
        ...
        "", "", "", "", "", "", "", "", "", "", "* My Contacts", "* ", "guybrush@monkey.net", "Other", "Yahoo!",
        "3headedmonkey", "Home", "7777", "Mobile", "8888", "Work Fax", "8000", "Work", "Melee Island", "", "", "",
