...
public class MailboxPreferencesTest extends XMLTestCase {
    ...
    public void testReadWritePreferences() throws IOException {
        ...
        expected.setAttachVoicemailToEmail(true);
        expected.setEmailPassword("password");
        expected.setEmailServerHost("host");
        expected.setEmailServerPort("123");
        expected.setEmailServerUseTLS(false);
        expected.setSynchronizeWithEmailServer(false);
