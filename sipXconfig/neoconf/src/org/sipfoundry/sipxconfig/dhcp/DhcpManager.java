...
public interface DhcpManager {
    public static final String ID = "dhcpd";
    public static final LocationFeature FEATURE = new LocationFeature(ID);
    public static final AddressType DHCPD_ADDRESS = new AddressType(ID, 67, AddressType.Protocol.udp);
