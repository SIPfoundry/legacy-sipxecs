...
public class PhonebookTestHelper {
    ...
    private Collection<User> m_usersInPhonebook;
    private Collection<PhonebookEntry> m_phonebookEntries;
    
    public PhonebookTestHelper() {
        m_usersInPhonebook = new ArrayList<User>();
        m_usersInPhonebook.add(createUser(FIRSTUSER_USERNAME, FIRSTUSER_FIRSTNAME, 
                USER_LASTNAME, "200 anotherUserName 501"));
    ...
    /**
     * Configures a core context mock object that was created with EasyMock.  This method 
     * leaves the mock open for further configuration... i.e. replay() is not called
    ...
    private PhonebookEntry createPhonebookEntry(final String number, 
