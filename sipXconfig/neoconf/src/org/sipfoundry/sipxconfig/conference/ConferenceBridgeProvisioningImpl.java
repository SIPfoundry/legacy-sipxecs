...
public abstract class ConferenceBridgeProvisioningImpl extends HibernateDaoSupport implements
    ...
    public abstract ConferenceAdmission createConferenceAdmission();
    ...
    public void deploy(Serializable bridgeId) {
        ...
        generateAdmissionData(conferences);
    ...
    void generateAdmissionData(List conferences) {
        ConferenceAdmission admission = createConferenceAdmission();
