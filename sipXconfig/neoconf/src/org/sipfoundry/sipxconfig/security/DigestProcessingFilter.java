 ...
 * Sipxconfig custom code inside START SIPXECS CUSTOM CODE / END SIPXECS CUSTOM CODE:
 * create DigestUsernamePasswordAuthenticationToken, Used in conjunction with
 * org.sipfoundry.sipxconfig.security.DaoAuthenticationProvider that handles
 * this type of tokens
 */
