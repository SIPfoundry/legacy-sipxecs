...
public class Schema {
    public static class ClassDefinition {
        ...
        private static final Pattern NAME_PATTERN = Pattern.compile("NAME '(\\w+)' DESC '(.*)'");
        private static final Pattern SUP_PATTERN = Pattern.compile("SUP (\\w+) ");
        private static final Pattern MUST_PATTERN = Pattern.compile("MUST \\( ([\\w\\s$]+) \\)");
        private static final Pattern MUST_SINGLE_PATTERN = Pattern.compile("MUST (\\w+) ");
        private static final Pattern MAY_PATTERN = Pattern.compile("MAY \\( ([\\w\\s$]+) \\)");
        private static final Pattern MAY_SINGLE_PATTERN = Pattern.compile("MAY (\\w+) ");
