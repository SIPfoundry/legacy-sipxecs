...
public abstract class RestorePage extends SipxBasePage implements PageBeginRenderListener {
    ...
    // }, new String[] {
    // getMessages().getMessage("backupPlan.type.local"),
    ...
    // }
    //
    // private IPage setupWaitingPage(Restore restore, boolean restoreConfig, boolean
    // restoreVoicemail,
    ...
    // getMessages().getMessage("message.remoteRestore.started"));
    ...
    // TapestryUtils.recordSuccess(this,
    // getMessages().getMessage("message.deviceconfig.restored"));
    // }
    // return null;
    // } else {
    // return null;
