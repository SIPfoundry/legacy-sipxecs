...
public class MillisDurationFormatTest extends TestCase {
    ...
    public void testZeroFormat() {
        ...
        assertEquals("1 second", m_format.format(new Long(1)));
        assertEquals("1 second", m_format.format(new Long(999)));
    }
    ...
    public void testFormat() {
        ...
        assertEquals("3 hours, 0 minutes, 6 seconds", m_format.format(new Long(
    ...
    public void testFormatPolish() {
        ...
        assertEquals("5 sekund", m_format.format(new Long(5000)));
        assertEquals("6 sekund", m_format.format(new Long(5999)));

        assertEquals("1 minuta, 4 sekundy", m_format.format(new Long(60000 + 4000)));
        assertEquals("1 minuta, 5 sekund", m_format.format(new Long(60000 + 5000)));

        assertEquals("2 minuty, 0 sekund", m_format.format(new Long(2 * 60000)));

        assertEquals("2 minuty, 5 sekund", m_format.format(new Long(2 * 60000 + 5000)));

        assertEquals("3 godziny, 0 minut, 6 sekund", m_format.format(new Long(
                3 * DateUtils.MILLIS_PER_HOUR + 5050)));
    ...
    public void testFormatNoLabels() {
        ...
        assertEquals("6", m_format.format(new Long(5999)));
    ...
    public void testFormatSeparator() {
        ...
        assertEquals("", m_format.format(new Long(0)));
        assertEquals("3:0:6", m_format.format(new Long(3 * DateUtils.MILLIS_PER_HOUR + 5050)));
        assertEquals("3:1:0", m_format.format(new Long(3 * DateUtils.MILLIS_PER_HOUR + 59050)));
    }
}
