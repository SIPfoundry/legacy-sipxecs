...
public class ConfigurationParser {
    ...
    private static void addCallMethodString(String elementName, String methodName) {
    ...
    private static void addCallMethodInt(String elementName, String methodName) {
        digester.addCallMethod(String.format("%s/%s", currentTag, elementName), methodName, 0, new Class[] {
            Integer.class
        });
    }
    ...
    private static void addRules() {
        ...
        digester.addSetNext(s2sTag, "setS2sInfo");
    ...
    public static WatcherConfig parse(String url) {
