 ...
 *
 * This class generates and interprets branch id values.  A sipX branch id value
...
class BranchId : protected UtlString
{
  ...
  private:
   ...
   /**<
    * @returns true if this branch id was recognized as a sipX branch id
    *
    ...
    * sipX implementation using this class.
    */
