...
#ifndef _MpeGIPSiPCMA_h_
#define _MpeGIPSiPCMA_h_

// APPLICATION INCLUDES
#include "mp/MpEncoderBase.h"
#include "mp/GIPS/gips_typedefs.h"

//:Derived class for GIPS iPCMA encoder.
class MpeGIPSiPCMA: public MpEncoderBase
{
/* //////////////////////////// PUBLIC //////////////////////////////////// */
public:

   MpeGIPSiPCMA(int payloadType);
     //:Constructor
     // Returns a new decoder object.
     //!param: payloadType - (in) RTP payload type associated with this decoder

   virtual ~MpeGIPSiPCMA(void);
     //:Destructor
...
private:
   ...
   EG711A_inst *pEncoderState;
};

#endif  // _MpeGIPSiPCMA_h_
#endif /* HAVE_GIPS ] */
