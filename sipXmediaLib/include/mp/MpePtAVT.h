...
//:Derived class for Pingtel AVT/Tone encoder.
class MpePtAVT: public MpEncoderBase
{
/* //////////////////////////// PUBLIC //////////////////////////////////// */
public:

   MpePtAVT(int payloadType);
     //:Constructor
     // Returns a new decoder object.
     //!param: payloadType - (in) RTP payload type assigned to this encoder

   virtual ~MpePtAVT(void);
     //:Destructor
