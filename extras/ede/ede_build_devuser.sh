...
sudo rm -rf $ECLIPSE_WINDOW_PREFS_FILE
echo "This value must be manually entered into Eclipse under" >> $ECLIPSE_WINDOW_PREFS_FILE
echo "   Window->Preferences->General->Workspace->Linked Resources" >> $ECLIPSE_WINDOW_PREFS_FILE
echo SIPX_OUT $WORKING_DIR/$INSTALL/bin >> $ECLIPSE_WINDOW_PREFS_FILE
echo "" >> $ECLIPSE_WINDOW_PREFS_FILE
echo "These values must be manually entered into Eclipse under" >> $ECLIPSE_WINDOW_PREFS_FILE
