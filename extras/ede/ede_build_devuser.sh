...
org.eclipse.jdt.core.classpathVariable.OPENFIRE-ROOT=$WORKING_DIR/BUILD/sipXopenfire
...
org.eclipse.jdt.core.classpathVariable.SIPX-PROJECT-ROOT=$WORKING_DIR/$CODE
EOF
