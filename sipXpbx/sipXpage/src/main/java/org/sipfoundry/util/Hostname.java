 ...
 * <p>
 * Tries various and sundry ways to get it, either from the command
 * line property "HOSTNAME", the environment variable "HOSTNAME", by
 * running the POSIX "uname -n" command, and finally trying a reverse
 * DNS lookup from what java.net.InetAddress.getLocalHost() returns.
 * 
 * @author Woof!
 *
 */
