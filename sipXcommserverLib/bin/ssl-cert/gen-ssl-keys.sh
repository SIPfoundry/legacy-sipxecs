...
configDir="/home/joegen/sipxecs-bin/etc/sipxpbx"
...
showUsage()
{
    ...
    See /home/joegen/sipxecs-bin/share/doc/sipxecs/INSTALL.ssl.{txt,html} for details on usage.
...
generatePKCS12PackageNoCACert ()
{
    ...
    # Generate the pkcs12 package only. Dont verify it.
...
################################################################
#### Generate only the pkcs package.
...
EOF
    ...
    /home/joegen/sipxecs-bin/bin/ssl-cert/install-cert.sh
EOF
...
Results:
  ...
  and then run this command as root in this directory:
      ...
      /home/joegen/sipxecs-bin/bin/ssl-cert/install-cert.sh ${serverName}${restrictionName}
