...
{
public:
   static const char* pImdbEntityDbName;        //"imdb.entity"
   static const char* pNodeRegistrarDbName;     //"node.registrar"
...
protected:
    ...
    * @param whereOptVector - A vector that will contain the filter conditions used for listing
    *    or deleting entries
    * @param databaseName - The name of selected database used for printing entries
    *
    */
