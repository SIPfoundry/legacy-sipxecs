...
Requires: sipx-w3c-libwww
Obsoletes: w3c-libwww-devel
...
[ -f configure.in ]
    CFLAGS="$RPM_OPT_FLAGS" ./configure --prefix=/usr --enable-shared --with-gnu-ld --with-regex --with-zlib --with-ssl
