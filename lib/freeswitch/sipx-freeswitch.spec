...
#
###############################################################################################################################
DIALPLANS_MODULES="dialplans/mod_dialplan_xml" # dialplans/mod_dialplan_asterisk dialplans/mod_dialplan_directory
###############################################################################################################################
#
#							Directory Modules
#
...
# Create some important dirs
%{__mkdir} -p $RPM_BUILD_ROOT%{prefix}/log
%{__mkdir} -p $RPM_BUILD_ROOT%{prefix}/run
...
###############################################################################################################################
%changelog
* Mon Sep 06 2010 - michal.bielicki@seventhsignal.de
- Adjusted to sipX, so disabled init scripts
- added erlang modules for OpenACD for sipx
- added libtiff and libjpeg runtime dependencies
- added relang runtime dependency
