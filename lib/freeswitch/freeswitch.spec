...
# Prevent a debuginfo package to be created
%define debug_package %{nil}

# Define the prefix where freeswitch will be installed
%define freeswitch_prefix /usr/local/freeswitch
...
# Create a log dir
mkdir -p $RPM_BUILD_ROOT%freeswitch_prefix/log
...
/usr/sbin/useradd -r -g freeswitch -s /bin/false -c "Freeswitch daemon" -d %freeswitch_prefix/var freeswitch 2> /dev/null || :
...
%files
%defattr(-,root,root)
%dir %attr(750,root,root) %freeswitch_prefix/db
%dir %attr(750,root,root) %freeswitch_prefix/log
%dir %attr(750,root,root) %freeswitch_prefix/log/xml_cdr
%dir %attr(750,root,root) %freeswitch_prefix/htdocs
%dir %attr(750,root,root) %freeswitch_prefix/scripts
#%dir %attr(750,root,root) %freeswitch_prefix/grammer
%dir %attr(750,root,root) %freeswitch_prefix/conf
%dir %attr(750,root,root) %freeswitch_prefix/conf/autoload_configs
%dir %attr(750,root,root) %freeswitch_prefix/conf/dialplan
%dir %attr(750,root,root) %freeswitch_prefix/conf/directory
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/en
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/en/demo
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/en/vm
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/de
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/de/demo
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/de/vm
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/fr
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/fr/demo
%dir %attr(750,root,root) %freeswitch_prefix/conf/lang/fr/vm
%dir %attr(750,root,root) %freeswitch_prefix/conf/sip_profiles
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/*.conf
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/autoload_configs/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/dialplan/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/directory/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/en/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/en/demo/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/en/vm/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/de/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/de/demo/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/de/vm/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/fr/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/fr/demo/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/lang/fr/vm/*.xml
%config(noreplace) %attr(750,root,root) %freeswitch_prefix/conf/sip_profiles/*.xml
/etc/ld.so.conf.d/*
%{_bindir}/freeswitch
#%freeswitch_prefix/bin/freeswitch
/etc/init.d/freeswitch
/etc/sysconfig/freeswitch
/usr/sbin/rcfreeswitch
#%freeswitch_prefix/lib/*.so*
%{_libdir}/*.so*
%freeswitch_prefix/mod/*.so*

%files codec-passthru-amr
%freeswitch_prefix/mod/mod_amr.so*

%files codec-passthru-g723_1
%freeswitch_prefix/mod/mod_g723_1.so*

%files codec-passthru-g729
%freeswitch_prefix/mod/mod_g729.so*

%files devel
%defattr(-,root,root)
%{_libdir}/*.a
%{_libdir}/*.la
%freeswitch_prefix/mod/*.a
%freeswitch_prefix/mod/*.la
%freeswitch_prefix/include/*.h
