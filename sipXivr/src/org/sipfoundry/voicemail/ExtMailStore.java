...
//    }   
//
//    public static void SaveSpokenNameInFolder(User user, File recording) {
//        SaveInFolder(new Mailbox(user), GreetingType.NONE, true, recording);
//    }
//
...
////                if (success) {
////                    Greeting greet = new Greeting(m_controller);
