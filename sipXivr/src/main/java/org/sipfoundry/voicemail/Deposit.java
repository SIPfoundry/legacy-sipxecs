...
public class Deposit {
    ...
    public String depositVoicemail() {
        ...
        Message message = Message.newMessage(m_mailbox, wavName, displayUri, Priority.NORMAL);
        ...
        for(;;) {
            ...
            if (digit.equals("2")) {
                ...
                vmMessage = message.getVmMessage();
                break ;
            }
    ...
    private void MoreOptions(VmMessage existingMessage) {
        ...
        for(;;) {
            ...
            // Do the copy dialog
            CopyMessage cm = new CopyMessage(m_vm, m_loc);
            cm.copyDialog(existingMessage);
        }
    }
}
