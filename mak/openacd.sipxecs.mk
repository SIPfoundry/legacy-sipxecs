...
sipxopenacd_PACKAGE_REVISION = 999$(shell cd $(SRC)/$(P); ../config/revision-gen $($(P)_VER) 2>/dev/null || echo 'missing')

openacd_PACKAGE_REVISION = $(shell cd $(SRC)/$(P); ../config/revision-gen $($(P)_VER) 2>/dev/null || echo 'missing')
