...
public:
   ...
   void testUserAlias()
	 ...
	 requestUri.setUrlParameter("sipxecs-lineid", "1");

         const char* message =
            "INVITE sip:target@example.org;sipxecs-lineid=1 SIP/2.0\r\n"
            "Via: SIP/2.0/TCP 10.1.1.3:33855\r\n"
   ...
   void testDomainAlias()
	 ...
	 requestUri.setUrlParameter("sipxecs-lineid", "2");

         const char* message =
            "INVITE sip:target@pstn-gateway.example.edu;sipxecs-lineid=2 SIP/2.0\r\n"
            "Via: SIP/2.0/TCP 10.1.1.3:33855\r\n"
          ...
          */
         const char* ackMessage =
            "ACK sip:target@example.org;sipxecs-lineid=1 SIP/2.0\r\n"
            "Via: SIP/2.0/TCP 10.1.1.3:33855\r\n"
            "To: sip:target@example.org;tag=4711018y5y1-1-1\r\n"
            "From: sip:505@example.edu;tag=30543f3483e1cb11ecb40866edd3295b\r\n"
            "Call-Id: f88dfabce84b6a2787ef024a7dbe8749\r\n"
