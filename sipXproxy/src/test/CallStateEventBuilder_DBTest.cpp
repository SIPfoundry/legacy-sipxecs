   ...
   void testRequest()
      {
         ...
         builder.callRequestEvent(1, testTime, "Contact <sip:requestor@sip.net>", "abcdef-ghijkl-mnopqrs@sip.net;rel=xfer");
         CPPUNIT_ASSERT(!builder.finishElement(event));
