...
public class MongoFactory {
	...
	public static final Mongo fromConnectionFile()
			...
			synchronized (FILE_LOCK) {
				...
				try {
					if (isBlank(configurationPath)) {
						...
						configurationPath = System.getProperty("conf.dir",
								"/etc/sipxpbx");
					}
	...
	public static final Mongo fromConnectionString(String connectionUrl)
			throws UnknownHostException {
