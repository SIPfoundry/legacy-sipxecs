...
public:
   ...
   virtual int run(void* pArg) {
     ...
     Os::Logger::instance().log(FAC_KERNEL, PRI_DEBUG, "SimpleTask::run task %p", (void *)this );
     m_numOfRuns++;
     ...
     Os::Logger::instance().log(FAC_KERNEL, PRI_DEBUG, "SimpleTask::run task %p done", (void *)this );
