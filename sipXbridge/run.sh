...
javac -classpath $classpath -sourcepath src/main/java -d classes -g:source src/main/java/org/sipfoundry/sipxbridge/*.java

java -classpath "$classpath:./classes" org.sipfoundry.sipxbridge.Gateway
