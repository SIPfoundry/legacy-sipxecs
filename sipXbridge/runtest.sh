...
java -classpath "$classpath" -Dconf.dir=./  -Dtester.address=192.168.5.240 -Dtester.callLoad=1 -Dtester.npackets=1000 -Dtester.startport=30000 org.sipfoundry.sipxbridge.symmitron.SymmitronThruputTest
