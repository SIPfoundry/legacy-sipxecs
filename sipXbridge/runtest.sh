...
java -classpath "$classpath:./classes" -Dconf.dir=/tmp  -Dtester.address=192.168.5.240 -Dtester.callLoad=120 -Dtester.npackets=4000 -Dtester.startport=30000 org.sipfoundry.sipxbridge.symmitron.SymmitronThruputTest
