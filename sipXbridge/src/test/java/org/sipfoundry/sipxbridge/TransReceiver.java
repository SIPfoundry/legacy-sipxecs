   ...
   public void startBridge(String bridge) throws Exception  {
    ...
    public TransReceiver(boolean server) throws Exception {
        ...
        if (server) {
            ...
            serverAddress = accountManager.getBridgeConfiguration().getExternalAddress();
            port = accountManager.getBridgeConfiguration()
            .getXmlRpcPort();
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ( args[0].equals("true") ) {
            transceiver = new TransReceiver( true);
        } else {
            transceiver = new TransReceiver(false);
        }
