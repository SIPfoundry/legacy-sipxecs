...
public class BackToBackUserAgent {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("replacedDialogPeerDialog = "
                        + ((DialogContext) replacedDialog.getApplicationData()).peerDialog);
    ...
    void referInviteToSipxProxy(Request inviteRequest, RequestEvent referRequestEvent,
        ...
        try {
            ...
            DialogContext newDialogApplicationData = DialogContext.attach(this, ct.getDialog(),
                    ct, ct.getRequest());
    ...
    void handleInviteWithReplaces(RequestEvent requestEvent, Dialog replacedDialog,
        ...
        try {
            ...
            if (replacedDialog.getState() == DialogState.CONFIRMED) {
                ...
                okResponse.setContent(
                        rtpSession.getReceiver().getSessionDescription().toString(), cth);
                ...
                DialogContext replacedDialogApplicationData = DialogContext.get(dialog);
    ...
    void processBye(RequestEvent requestEvent) throws SipException {
        ...
        if (dialogContext.forwardByeToPeer && peer != null
            ...
            TransactionContext transactionContext = TransactionContext.attach(st,
