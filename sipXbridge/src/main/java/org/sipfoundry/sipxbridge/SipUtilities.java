...
public class SipUtilities {
    ...
    public static String getSessionDescriptionMediaAttribute(SessionDescription sessionDescription) {
        try {
            MediaDescription mediaDescription = (MediaDescription) sessionDescription
                    .getMediaDescriptions(true).get(0);
    ...
    public static void setSessionDescriptionMediaAttribute(SessionDescription sessionDescription, String attributeValue) {
    ...
    public static void fixupSdpAddresses(SessionDescription sessionDescription,
        ...
        try {
            ...
            String address = useGlobalAddress ? Gateway.getGlobalAddress() : Gateway.getLocalAddress();
