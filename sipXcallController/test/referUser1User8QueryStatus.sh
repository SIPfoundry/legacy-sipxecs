...
echo "user8 must not exist."
curl  -k -X POST -u user1:123  https://sipxtest.sipxtest.net:6666/callcontroller/user1/user8?timeout=10\&resultCacheTime=30
sleep 20
echo "Query call setup progress for call between 201 and 202 as 201"
curl -k -u user1:123 https://sipxtest.sipxtest.net:6666/callcontroller/user1/user8
