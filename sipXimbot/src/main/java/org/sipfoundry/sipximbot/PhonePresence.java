...
public class PhonePresence {
    ...
    public PhonePresence() throws Exception {
        ...
        this.presenceClient = new OpenfireXmlRpcPresenceClient(ImbotConfiguration.get().getOpenfireHost(),
                ImbotConfiguration.get().getOpenfireXmlRpcPort(), config.getSharedSecret());
    }
