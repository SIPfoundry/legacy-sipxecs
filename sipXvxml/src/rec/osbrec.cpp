...
static VXIrecResult OSBrecBeginSession(VXIrecInterface * pThis, VXIMap *sessionArgs)
{
                                                ...
                                                VXIrecGrammar **gram)
{
  ...
  OSBrecData* tp = GetRecData(pThis);
  if (tp == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
  if (str == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
                                      ...
                                      VXIrecGrammar **gram)
{
  ...
  if (gram == NULL || *gram == NULL) return VXIrec_RESULT_SUCCESS;
                                          ...
                                          VXIrecGrammar *gram)
{
  ...
  if (tp == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
  if (gram == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
...
static int getRecordedData(OsProtectedEvent* recordEvent, 
                           int& dtmfterm, 
                           double& duration)
{
...
static VXIrecResult OSBrecRecord(VXIrecInterface *pThis,
                                 const VXIMap *props,
                                 VXIrecRecordResult **recordResult)
{
   OSBrecData* tp = GetRecData(pThis);
   if (tp == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
   if (recordResult == NULL) return VXIrec_RESULT_INVALID_ARGUMENT;
